...
describe('<OrderModal />', () => {
  ...
  describe('archived', () => {
    ...
    const wrapper = mount(<OrderModal showModal
                                      archived
                                      order={otherOrder}
                                      currentUser={user}
                                      closeModal={() => {}} />);
  ...
  describe('user is able to add line item', () => {
    ...
    otherOrder.line_items = [];
    otherOrder.status = 'open';
    const wrapper = shallow(<OrderModal showModal
                                        archived={false}
                                        order={otherOrder}
                                        currentUser={user}
                                        closeModal={() => {}} />);
  ...
  describe('user is an owner', () => {
    describe('archived', () => {
      const wrapper = shallow(<OrderModal archived
                                          showModal
                                          order={order}
                                          currentUser={order.owner}
                                          closeModal={() => {}} />);
    ...
    describe('not archived', () => {
      const wrapper = shallow(<OrderModal archived={false}
